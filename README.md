...
| `/matchups` | Матрица матчапов: процент побед и размер выборки, 2–40 колод |
...
Контекст backend-задач: продукт, отображаемые данные и проверенные ограничения API:
[PROJECT_AUDIT.md](readme/PROJECT_AUDIT.md).
